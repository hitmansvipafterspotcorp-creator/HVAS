...
// PayPal.me — the instant path (no setup, real money to your PayPal). The handle
// comes from the connected venue's config, else the build env. On the PayPal.me
// page the buyer can pay with card, Apple Pay, Venmo, or balance.
import { paypalMeHandle } from './api.js';
export const paypalMeEnabled = () => !!paypalMeHandle();
export const paypalMeLink = (usd) => `https://www.paypal.com/paypalme/${paypalMeHandle()}/${usd}USD`;
