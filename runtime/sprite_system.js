...
const SpriteSystem = (() => {
  ...
  const CHAR_DEFS = {
    ...
    // ── KENDRICK (id:14) — Cafe8Fifty headliner fighter ─────────────────────
    14: {
      sheets: {
        loco:   'assets/characters/kendrick_sheet01_loco.png',
        combat: 'assets/characters/kendrick_sheet02_combat.png',
        damage: 'assets/characters/kendrick_sheet03_damage.png',
        supers: 'assets/characters/kendrick_sheet04_supers.png',
        topdown:'assets/characters/kendrick_sheet05_topdown.png',
        vfx:    'assets/characters/kendrick_sheet06_vfx.png',
      },
      anims: {
        idle:{sheet:'loco',row:0,frames:8,fps:6,loop:true},
        walk:{sheet:'loco',row:1,frames:8,fps:10,loop:true},
    ...
    20: {
      ...
      anims: {
        ...
        recover:{sheet:'damage',row:4,frames:8,fps:10,loop:false},
        super1:{sheet:'supers',row:0,frames:8,fps:14,loop:false,superFlash:true},
        super2:{sheet:'supers',row:1,frames:8,fps:14,loop:false,superFlash:true},
        super3:{sheet:'supers',row:2,frames:8,fps:14,loop:false,superFlash:true},
        finisher:{sheet:'supers',row:3,frames:8,fps:10,loop:false,superFlash:true},
    ...
    21: {
      ...
      anims: {
        ...
        recover:{sheet:'damage',row:4,frames:8,fps:9,loop:false},
        super1:{sheet:'supers',row:0,frames:8,fps:14,loop:false,superFlash:true},
